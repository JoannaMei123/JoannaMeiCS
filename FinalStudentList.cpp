...
void addCmd(vector <structureInfo>&vecList);
void printCmd(vector <structureInfo>&vecList);
void deleteCmd(vector <structureInfo>&vecList);
...
e student information, and DELETE to remove the student. If you want to quit the program, enter QUIT" <\
< endl;
